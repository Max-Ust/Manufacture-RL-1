...
namespace MRL_1
{
    ...
    public partial class Form1 : Form
    {
        ...
        double A = 0.9; // Скорость обучения
        ...
        static double RCount(int[,] S)
        {
            ...
            for(int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    ...
                    // Получем одну единицу награды за каждый завод первого этапа обработки (О), соединенный (по ребру) с заводом второго этапа (Х)
                }
            }
        ...
        // Вывод получившегося результата. В данной версии программы завод первого этапа обработки представлен в виде O, второго — Х
